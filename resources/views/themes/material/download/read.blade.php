				...
				<div class="contentdownload">
					...
					<div class="col-md-8">
						...
						<div class="commentdownload">
							...
							@include('themes.material.partials.comments')
					...
					<div class="col-md-4">
						...
						<div class="btn-next-prev">
							...
							@if(isset($previous))
								<a href="{{ route('download', $previous->slug) . $modal }}" class="btn btn-info"><i style="font-size:10px; position:relative; top:-1px;" class="fa fa-chevron-left"></i> <span>Previous</span></a>
							@endif
							
							@if(isset($next))
								<a href="{{ route('download', $next->slug) . $modal }}" class="btn btn-info"><span>Next</span> <i class="fa fa-chevron-right" style="font-size:10px; position:relative; top:-1px;"></i></a>
							@endif
