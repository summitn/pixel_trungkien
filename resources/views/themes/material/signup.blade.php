...
<head>
    ...
    <title>Register - <?php echo e(Voyager::setting("title")); ?></title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig" style="top: 0; margin-top: 10px; ">

                <h2>Sign up Below:</h2>

                <form action="<?php echo e(route('post-sign-up')); ?>" method="POST">
                    ...
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="glyphicon glyphicon-refresh"></span> SignUp in...</span>
